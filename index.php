...
if ($isBD) {
    ...
    $premiereEntree = ($page - 1) * $produitsParPage;
...
<div class="jumbotron" style="background-image: url(<?php echo $documentRoot; ?>/img/fond/fond.png)">
    <div class="container" >
        ...
        <div id="textPresentation"><?php include('page/index.html'); ?></div>
            ...
            if ($produit->getVisible() !== 'I') {
                ...
                <div class="col-md-4">
                    <div class="thumbnail" style="height:458px">
                        <a href="produit/detail.php?id=<?php echo $produit->getId(); ?>"><img src="<?php echo $documentRoot . $produit->getUrlImage(); ?>" alt="<?php echo $produit->getAltImage(); ?>" style="width:auto;height:280px;"></a>
                        <div class="caption">
                            <h2 class="titreBloc"><?php echo $produit->getNom(); ?></h2>
                            <p><?php echo $produit->getPrix(); ?> $ CAD</p>
                            <p><a class="btn btn-default" style="position:absolute;bottom:35px;right:30px" href="produit/detail.php?id=<?php echo $produit->getId(); ?>" role="button">Détails</a></p>
                        </div>
                    </div>
                </div>
            <?php }
